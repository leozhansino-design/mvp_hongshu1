...
const TEST_PRODUCTS: Record<string, {
  ...
  'enneagram': {
    ...
    subtitle: '你知道自己的性格吗？ | 探索你的核心人格类型',
    description: '九型人格将人的性格分为九种核心类型，揭示你内在最深层的价值观、恐惧和渴望。专业的144道题目测试，12页精美报告，帮你真正了解自己的优势和成长方向。适合想要自我探索的人，热衷于自我探索的人，你一定不要错过！',
    color: '#F5F0FF',
    questionCount: 144,
    duration: '15-20分钟',
    priceBasic: 198,
